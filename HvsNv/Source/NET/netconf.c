...
//define if ip... be modified
u8 IP_ADDR0_m = 192;   
u8 IP_ADDR1_m = 168;   
u8 IP_ADDR2_m = 1;   
u8 IP_ADDR3_m = 200; 
u8 NETMASK_ADDR0_m = 255;   
u8 NETMASK_ADDR1_m = 255;   
u8 NETMASK_ADDR2_m = 255;   
u8 NETMASK_ADDR3_m = 0;
u8 GW_ADDR0_m = 192;   
u8 GW_ADDR1_m = 168;   
u8 GW_ADDR2_m = 1;   
u8 GW_ADDR3_m = 1;
...
void LwIP_Init(void)
{
  ...
  if (g_IpAllModified == 1) {
	  IP4_ADDR(&ipaddr, IP_ADDR0_m, IP_ADDR1_m, IP_ADDR2_m, IP_ADDR3_m);
	  IP4_ADDR(&netmask, NETMASK_ADDR0_m, NETMASK_ADDR1_m , NETMASK_ADDR2_m, NETMASK_ADDR3_m);
	  IP4_ADDR(&gw, GW_ADDR0_m, GW_ADDR1_m, GW_ADDR2_m, GW_ADDR3_m);
  }
	//
	memcpy(g_MCUinfo.mcuIP,&ipaddr,4);
	memcpy(g_MCUinfo.mcuNetMask,&netmask,4);
	memcpy(g_MCUinfo.mcuGW,&gw,4);
#endif  
